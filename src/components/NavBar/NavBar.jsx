...
<div className="navbar bg-base-100" >
  ...
  <div className="dropdown">
      ...
      <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p- shadow bg-base-300 rounded-box w-52">
  ...
  <div className="navbar-center hidden lg:flex tabs">
    <ul className="menu menu-horizontal px-4 py-6 ">
      ...
      <li><Link to={`/rooms`}>
        <button className="btn btn-outline btn-secondary btn-xs sm:btn-sm md:btn-md lg:btn-lg px-5 mx-10">Rooms</button>
      </Link></li>
      <li><Link to={`/contactus`}  >
        <button className="btn btn-outline btn-secondary btn-xs sm:btn-sm md:btn-md lg:btn-lg px-5 mx-10">Contact Us</button>
        </Link></li>
    </ul>
  </div>
